...
class WhiteBoard extends JFrame {
    ...
    private void initComponents() {
        ...
        miSelectShape = new JMenuItem();
        miSetStroke = new JMenuItem();
        miSetColor = new JMenuItem();
        miBack = new JMenuItem();
    ...
    private JMenuItem miSelectShape;
    private JMenuItem miSetColor;
    private JMenuItem miSetStroke;
