...
public class ChangePassword extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabelChagePassCP = new JLabel();
        jLabelPhoneCP = new JLabel();
        jLabelPasswordCP = new JLabel();
        jLabelNewPassCP = new JLabel();
        jLabelConfirmPassCP = new JLabel();
        btChangePass = new JButton();
        tfPhoneCP = new JTextField();
        tfConfirmCP = new JPasswordField();
        tfPasswordCP = new JPasswordField();
    ...
    private JLabel jLabelChagePassCP;
    private JLabel jLabelPhoneCP;
    private JLabel jLabelPasswordCP;
    private JLabel jLabelNewPassCP;
    private JLabel jLabelConfirmPassCP;
    private JPasswordField tfConfirmCP;
    private JPasswordField tfNewPassCP;
    private JPasswordField tfPasswordCP;
